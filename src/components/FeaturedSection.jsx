    ...
    <section className="featured-section">
      <div className="featured-content">
        ...
        <p className="featured-description">
          ...
          eget consectetur. blandit interdum. Sed pellentesque at nunc eget consectetur. eget consectetur.
        </p>
        <div className="tour-grid">
          {featuredTours.map((tour) => (
            <div key={tour.id} className="tour-card">
              <img src="https://moroccanexperiencetours.com/wp-content/uploads/2022/07/Destination-Image-10-1-768x519.jpg" alt={tour.title} width={300} height={200} />
