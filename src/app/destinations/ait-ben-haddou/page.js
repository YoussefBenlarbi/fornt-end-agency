...
export default function AitBenHaddouPage() {
  const destination = "Ait Ben Haddou";
            ...
            <div className={styles.destinationContent}>
              ...
              <div className={styles.contentContainer}>
                <h2 className={styles.sectionTitle}>
                  Discovering the Blue Pearl of Morocco: A Tourist's Guide to Ait ben Haddou
                </h2>
                <p className={styles.sectionContent}>
                  Located in the heart of Morocco's Rif Mountains, Ait ben Haddou
                  ...
                  Ait ben Haddou is a must-visit destination for travelers who
                ...
                <p className={styles.sectionContent}>
                  The nearest airports to Ait ben Haddou are Tangier Ibn Battouta
                ...
                <p className={styles.sectionContent}>
                  Once you arrive in Ait ben Haddou, the best way to explore the
                  ...
                  must-see attractions in Ait ben Haddou is the Kasbah Museum,
                  ...
                  Another highlight of Ait ben Haddou is the Ras El Maa
                ...
                <p className={styles.sectionContent}>
                  Ait ben Haddou is known for its vibrant markets and colorful
                  ...
                  of the most famous products of Ait ben Haddou is its cannabis,
                  which is widely available in the markets and is used in
                  traditional medicines and cosmetics.
                </p>

                <h2 className={styles.sectionTitle}>
                  Dining in Ait ben Haddou
                </h2>
                <p className={styles.sectionContent}>
                  Ait ben Haddou has a wide variety of dining options to suit all
                  ...
                  chicken, almonds, and spices. In conclusion, Ait ben Haddou is
                ...
                <div className={styles.mapContainer}>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13589.458642740714!2d-7.139722697265625!3d31.047222!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xdbb10e13d2bfbd9%3A0xfe69c197b2418a3c!2sA%C3%AFt%20Ben%20Haddou%2C%20Morocco!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen=""
