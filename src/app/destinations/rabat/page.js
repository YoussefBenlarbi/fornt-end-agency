            ...
            <div className={styles.destinationContent}>
              ...
              <div className={styles.contentContainer}>
                ...
                <p className={styles.sectionContent}>
                  Located in the heart of Morocco's Rif Mountains, Rabat is a
                  charming and peaceful town that is renowned for its stunning
                ...
                <h2 className={styles.sectionTitle}>Exploring Rabat</h2>
                <p className={styles.sectionContent}>
                  Once you arrive in Rabat, the best way to explore the town is
                  ...
                  attractions in Rabat is the Kasbah Museum, which is housed in
                  ...
                  religious sites in the town. Another highlight of Rabat is the
                  Ras El Maa waterfall, which is a beautiful natural site
                ...
                <p className={styles.sectionContent}>
                  Rabat is known for its vibrant markets and colorful
                  ...
                  the most famous products of Rabat is its cannabis, which is
                  widely available in the markets and is used in traditional
                  medicines and cosmetics.
                </p>

                <h2 className={styles.sectionTitle}>Dining in Rabat</h2>
                <p className={styles.sectionContent}>
                  Rabat has a wide variety of dining options to suit all tastes
                  ...
                  chicken, almonds, and spices. In conclusion, Rabat is a
                  ...
                  relaxing getaway, Rabat has something to offer. Plan your trip
                  today and discover the magic of the Blue Pearl of Morocco.
                </p>
                <h2 className={styles.sectionTitle}>Location</h2>
                <div className={styles.mapContainer}>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d106090.59014921926!2d-6.890673658203125!3d34.01590865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xda76b871f50c5c1%3A0x7ac946ed7408076b!2sRabat%2C%20Morocco!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen=""
