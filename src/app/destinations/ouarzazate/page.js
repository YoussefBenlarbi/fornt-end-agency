        ...
        <div className={styles.pageLayout}>
          <div className={styles.mainContent}>
            ...
            <div className={styles.destinationContent}>
              <img
                src="https://lh5.googleusercontent.com/p/AF1QipO6D1Bl0nzEV-aAxvNzxIVYU9JDHaAbl2_-voV-=w675-h390-n-k-no"
                alt="Ouarzazate"
              ...
              <div className={styles.contentContainer}>
                <h2 className={styles.sectionTitle}>
                  Discovering the Blue Pearl of Morocco: A Tourist's Guide to Ouarzazate
                </h2>
                <p className={styles.sectionContent}>
                  Located in the heart of Morocco's Rif Mountains, Ouarzazate
                  ...
                  Ouarzazate is a must-visit destination for travelers who
                ...
                <p className={styles.sectionContent}>
                  The nearest airports to Ouarzazate are Tangier Ibn Battouta
                ...
                <p className={styles.sectionContent}>
                  Once you arrive in Ouarzazate, the best way to explore the
                  ...
                  must-see attractions in Ouarzazate is the Kasbah Museum,
                  ...
                  Another highlight of Ouarzazate is the Ras El Maa
                ...
                <p className={styles.sectionContent}>
                  Ouarzazate is known for its vibrant markets and colorful
                  ...
                  of the most famous products of Ouarzazate is its cannabis,
                  which is widely available in the markets and is used in
                  traditional medicines and cosmetics.
                </p>

                <h2 className={styles.sectionTitle}>
                  Dining in Ouarzazate
                </h2>
                <p className={styles.sectionContent}>
                  Ouarzazate has a wide variety of dining options to suit all
                  ...
                  chicken, almonds, and spices. In conclusion, Ouarzazate is
                  ...
                  relaxing getaway, Ouarzazate has something to offer. Plan
                ...
                <div className={styles.mapContainer}>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d54054.80632853158!2d-6.893270!3d30.919167!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xdbb103cea40415d%3A0x3e06de9f1c2e7f0a!2sOuarzazate%2C%20Morocco!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen=""
