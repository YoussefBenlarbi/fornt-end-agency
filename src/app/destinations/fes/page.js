        ...
        <div className={styles.pageLayout}>
          <div className={styles.mainContent}>
            ...
            <div className={styles.destinationContent}>
              <img
                src="https://encrypted-tbn3.gstatic.com/licensed-image?q=tbn:ANd9GcR7zPx5ffZP6eathDH6bER8_k3CFaZAAFYJdx3sv_hT19NmeqGzGc5Sqp2FrTV9tZOT0ERJv73570OsrzxcAtbcFobt8xzRj_2wBQvbxg"
                alt="Fes"
              ...
              <div className={styles.contentContainer}>
                <h2 className={styles.sectionTitle}>
                  Discovering the Blue Pearl of Morocco: A Tourist's Guide to Fes
                </h2>
                <p className={styles.sectionContent}>
                  Located in the heart of Morocco's Rif Mountains, Fes
                  ...
                  Fes is a must-visit destination for travelers who
                ...
                <p className={styles.sectionContent}>
                  The nearest airports to Fes are Tangier Ibn Battouta
                ...
                <p className={styles.sectionContent}>
                  Once you arrive in Fes, the best way to explore the
                  ...
                  must-see attractions in Fes is the Kasbah Museum,
                  ...
                  Another highlight of Fes is the Ras El Maa
                ...
                <p className={styles.sectionContent}>
                  Fes is known for its vibrant markets and colorful
                  ...
                  of the most famous products of Fes is its cannabis,
                ...
                <p className={styles.sectionContent}>
                  Fes has a wide variety of dining options to suit all
                  ...
                  chicken, almonds, and spices. In conclusion, Fes is
                  ...
                  relaxing getaway, Fes has something to offer. Plan
                ...
                <div className={styles.mapContainer}>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d106376.72690372647!2d-5.0381311665059!3d34.033052654794735!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd9f8b484d445777%3A0x10e6aaaeedd802ef!2sFez%2C%20Morocco!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen=""
