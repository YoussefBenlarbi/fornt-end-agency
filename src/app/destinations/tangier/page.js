            ...
            <div className={styles.destinationContent}>
              ...
              <div className={styles.contentContainer}>
                <h2 className={styles.sectionTitle}>
                  Discovering the Blue Pearl of Morocco: A Tourist's Guide to Tangier
                </h2>
                <p className={styles.sectionContent}>
                  Located in the heart of Morocco's Rif Mountains, Tangier
                  ...
                  Tangier is a must-visit destination for travelers who
                ...
                <p className={styles.sectionContent}>
                  The nearest airports to Tangier are Tangier Ibn Battouta
                ...
                <p className={styles.sectionContent}>
                  Once you arrive in Tangier, the best way to explore the
                  ...
                  must-see attractions in Tangier is the Kasbah Museum,
                  ...
                  Another highlight of Tangier is the Ras El Maa
                ...
                <p className={styles.sectionContent}>
                  Tangier is known for its vibrant markets and colorful
                  ...
                  of the most famous products of Tangier is its cannabis,
                ...
                <p className={styles.sectionContent}>
                  Tangier has a wide variety of dining options to suit all
                  ...
                  chicken, almonds, and spices. In conclusion, Tangier is
                  ...
                  relaxing getaway, Tangier has something to offer. Plan
                ...
                <div className={styles.mapContainer}>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d103599.03431099928!2d-5.8662155!3d35.7594651!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd0b875cf04c132d%3A0x76bfc571bfb4e17a!2sTangier%2C%20Morocco!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen=""
