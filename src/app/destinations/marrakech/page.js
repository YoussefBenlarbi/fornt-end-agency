        ...
        <div className={styles.pageLayout}>
          <div className={styles.mainContent}>
            ...
            <div className={styles.destinationContent}>
              <img
                src="https://encrypted-tbn2.gstatic.com/licensed-image?q=tbn:ANd9GcRF25llPnzVBbZCpaLgWk1I9N537w5s8OTVwxVNvDn5vbw9DuPnFyaieIBNDLCersKVM7qrcta7PqWkeVVJk2pH9oyp7Dm5QyqzJ6apNA"
                alt="Marrakech"
              ...
              <div className={styles.contentContainer}>
                <h2 className={styles.sectionTitle}>
                  Discovering the Blue Pearl of Morocco: A Tourist's Guide to Marrakech
                </h2>
                <p className={styles.sectionContent}>
                  Located in the heart of Morocco's Rif Mountains, Marrakech
                  ...
                  Marrakech is a must-visit destination for travelers who
                ...
                <p className={styles.sectionContent}>
                  The nearest airports to Marrakech are Tangier Ibn Battouta
                ...
                <p className={styles.sectionContent}>
                  Once you arrive in Marrakech, the best way to explore the
                  ...
                  must-see attractions in Marrakech is the Kasbah Museum,
                  ...
                  Another highlight of Marrakech is the Ras El Maa
                ...
                <p className={styles.sectionContent}>
                  Marrakech is known for its vibrant markets and colorful
                  ...
                  of the most famous products of Marrakech is its cannabis,
                ...
                <p className={styles.sectionContent}>
                  Marrakech has a wide variety of dining options to suit all
                  ...
                  chicken, almonds, and spices. In conclusion, Marrakech is
                  ...
                  relaxing getaway, Marrakech has something to offer. Plan
                ...
                <div className={styles.mapContainer}>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d108703.59692350494!2d-8.0780139!3d31.6294723!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xdafee8d96179e51%3A0x5950b6534f87adb8!2sMarrakesh%2C%20Morocco!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen=""
