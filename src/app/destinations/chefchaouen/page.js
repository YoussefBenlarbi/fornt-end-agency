            ...
            <div className={styles.destinationContent}>
              ...
              <div className={styles.contentContainer}>
                <h2 className={styles.sectionTitle}>
                  Discovering the Blue Pearl of Morocco: A Tourist's Guide to Chefchaouen
                </h2>
                <p className={styles.sectionContent}>
                  Located in the heart of Morocco's Rif Mountains, Chefchaouen
                  ...
                  Chefchaouen is a must-visit destination for travelers who
                ...
                <p className={styles.sectionContent}>
                  The nearest airports to Chefchaouen are Tangier Ibn Battouta
                ...
                <p className={styles.sectionContent}>
                  Once you arrive in Chefchaouen, the best way to explore the
                  ...
                  must-see attractions in Chefchaouen is the Kasbah Museum,
                  ...
                  Another highlight of Chefchaouen is the Ras El Maa
                ...
                <p className={styles.sectionContent}>
                  Chefchaouen is known for its vibrant markets and colorful
                  ...
                  of the most famous products of Chefchaouen is its cannabis,
                ...
                <p className={styles.sectionContent}>
                  Chefchaouen has a wide variety of dining options to suit all
                  ...
                  chicken, almonds, and spices. In conclusion, Chefchaouen is
                ...
                <div className={styles.mapContainer}>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d51925.95198304441!2d-5.2936382!3d35.1683284!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd0b4359e0784757%3A0x5981b2df812af5c3!2sChefchaouen%2C%20Morocco!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen=""
