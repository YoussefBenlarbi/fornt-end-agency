            ...
            <div className={styles.destinationContent}>
              ...
              <div className={styles.contentContainer}>
                <h2 className={styles.sectionTitle}>
                  Discovering the Blue Pearl of Morocco: A Tourist's Guide to Merzouga
                </h2>
                <p className={styles.sectionContent}>
                  Located in the heart of Morocco's Rif Mountains, Merzouga
                  ...
                  Merzouga is a must-visit destination for travelers who
                ...
                <p className={styles.sectionContent}>
                  The nearest airports to Merzouga are Tangier Ibn Battouta
                ...
                <p className={styles.sectionContent}>
                  Once you arrive in Merzouga, the best way to explore the
                  ...
                  must-see attractions in Merzouga is the Kasbah Museum,
                  ...
                  Another highlight of Merzouga is the Ras El Maa
                ...
                <p className={styles.sectionContent}>
                  Merzouga is known for its vibrant markets and colorful
                  ...
                  of the most famous products of Merzouga is its cannabis,
                ...
                <p className={styles.sectionContent}>
                  Merzouga has a wide variety of dining options to suit all
                  ...
                  chicken, almonds, and spices. In conclusion, Merzouga is
                  ...
                  relaxing getaway, Merzouga has something to offer. Plan
                ...
                <div className={styles.mapContainer}>
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d27765.03186606518!2d-4.0266942!3d31.0886202!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd9876e0c5743963%3A0x6d487f7893a731c9!2sMerzouga%2C%20Morocco!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen=""
